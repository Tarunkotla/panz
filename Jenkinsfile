  ...
  stages {
   ...
   stage('Docker build and push') {
	 ...
	 echo $access_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD https://546272768196.dkr.ecr.ap-south-1.amazonaws.com
         docker build -t 546272768196.dkr.ecr.ap-south-1.amazonaws.com/sample:SAMPLE-PROJECT-${BUILD_NUMBER} .
         docker push 546272768196.dkr.ecr.ap-south-1.amazonaws.com/sample:SAMPLE-PROJECT-${BUILD_NUMBER}
